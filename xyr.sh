...
function authentication() {
    echo -n -e "请输入聚力网络™官方网址 [\033[32m $key \033[0m] ："
    read PASSWD
    readkey=$PASSWD
    if [[ ${readkey%%\ *} == $key ]]
    then
		...
		echo -e '\033[33m	聚力流控交流群：756823984	何以潇QQ：1744744000  欢迎你的加入！\033[0m'
		echo -e '\033[33m=========================================================\033[0m'
...
clear
echo -e '\033[36m何以潇™提示您：输入错误请按 Ctrl键 + 退格键 进行删除\033[0m';
echo
...
echo
echo -n -e "请输入网站名称(默认名称 聚力网络):"
read webname
if [[ -z $webname ]]
	then
		webname=聚力网络
		echo -e '[\033[32m  已设置网站名字为:聚力网络  \033[0m]';
	else
...
if [[ $llwsapp == "y" ]] || [[ $llwsapp == "Y" ]] || [[ $llwsapp == "" ]];then
		echo
		echo -n -e "请输入APP名称(默认:聚力网络):"
		read app_name
	if [[ -z $app_name ]]
		then
			echo -e '[\033[32m  已设置App名称:聚力网络  \033[0m]';
			app_name=聚力网络
		else
...
wget ${http}${host}${vpnfile}${jiankong_tcp} >/dev/null 2>&1
...
wget ${http}${host}${vpnfile}${jiankong_udp} >/dev/null 2>&1
...
------------------------------------------------------------
聚力网络流控官方交流群：756823984	何以潇QQ：1744744000 
------------------------------------------------------------
...
echo
echo -e "\033[34m何以潇提示：秘钥随便输入！\033[0m"
...
echo -e '\033[33m               官方网址：http://www.juliwangluo.cn/\033[0m'
echo -e '\033[31m               聚力流控交流群：756823984	何以潇QQ：1744744000  欢迎你的加入！\033[0m'
echo -e '\033[33m==========================================================================\033[0m'
exit 0;
else
if [[ "$kcard" == "yes" ]]
